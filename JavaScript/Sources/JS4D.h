...
#define V8_USE_MALLOC_IN_PLACE 1
...
public:
	...
	typedef PersistentValue*								ValueRef;
	typedef PersistentValue*								ObjectRef;
	typedef PersistentValue*								ExceptionRef;
#else
...
#if  USE_V8_ENGINE
	typedef void(__cdecl *ObjectInitializeCallback) (ContextRef ctx, const XBOX::VJSObject& object);
//	typedef void (__cdecl *ObjectCallAsConstructorCallback) (VJSParms_callAsConstructor* parms);
	...
	typedef void (*ObjectFinalizeCallback)(void* inPrivateData);
	...
	typedef bool(*ObjectDeletePropertyCallback) (XBOX::VJSParms_deleteProperty* ioParms, void *inData);
#else
...
#endif
#if  USE_V8_ENGINE
	typedef void(__cdecl *ObjectGetPropertyNamesCallback) (const v8::PropertyCallbackInfo<v8::Array>& info, std::vector<XBOX::VString>& outPropertyNames);
	...
	typedef bool (__cdecl *ObjectHasInstanceCallback)  ();
	static	bool					ValueToVJSONValue( ContextRef inContext, const v8::Handle<v8::Value>& inValue, VJSONValue& outJSONValue, VJSException *outException);
	...
	static	void					VValueToValue(VJSValue& ioValue, const XBOX::VValueSingle& inValue, VJSException *outException, bool simpleDate);
#if V8_USE_MALLOC_IN_PLACE
	static	void					_VJSONValueToValue(VJSValue& ioValue, const VJSONValue& inValue, VJSException *outException, void* IOConvertedObjects);
#else
	static	void					_VJSONValueToValue(VJSValue& ioValue, const VJSONValue& inValue, VJSException *outException, std::map<VJSONObject*, JS4D::ObjectRef>& ioConvertedObjects);
#endif
	// converts a JavaScriptCore value into a xbox VJSONValue.
	static	void					VJSONValueToValue(VJSValue& ioValue, const XBOX::VJSONValue& inValue, VJSException *outException);
#else
	// produces a js null value if VValueSingle is null
	...
	static	void					VFileToObject(VJSObject& ioObject, XBOX::VFile *inFile, VJSException *outException);
	static	void					VFolderToObject(XBOX::VJSObject& ioObject, XBOX::VFolder *inFolder, VJSException *outException);
	static	void					VFilePathToObjectAsFileOrFolder(XBOX::VJSObject& ioObject, const XBOX::VFilePath& inPath, VJSException *outException);
	static	XBOX::VValueSingle*		ValueToVValue(ContextRef inContext, const v8::Handle<v8::Value>& inValue, VJSException *outException = NULL, bool simpleDate = false);
	...
	static	XBOX::VValueSingle*		ValueToVValue(ContextRef inContext, JS4D::ValueRef inValue, ExceptionRef *outException = NULL, bool simpleDate = false);
...
template<class Type>
...
#if USE_V8_ENGINE
	static	double					VTimeToDouble(const XBOX::VTime& inTime, bool simpleDate);
#else
...
#if USE_V8_ENGINE
	static	bool					DateObjectToVTime(ContextRef inContext, const v8::Handle<v8::Value>& inValue, XBOX::VTime& outTime, VJSException *outException, bool simpleDate);
#else
...
#if USE_V8_ENGINE
	static	bool					ValueToVDuration( ContextRef inContext, const v8::Handle<v8::Value>& inValue, XBOX::VDuration& outDuration, VJSException *outException);
	// evaluates some javascript text and returns the result in outValue.
	static	void					EvaluateScript( ContextRef inContext, const XBOX::VString& inScript, VJSValue& outValue, VJSException *outException);
#else
	...
	static	EType					GetValueType( ContextRef inContext, const VJSValue& inValue);
	...
	*/
	...
	static	bool					ConvertErrorContextToException(ContextRef inContext, VErrorContext *inErrorContext, VJSException *outException); 
