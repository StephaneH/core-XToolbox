...
public:
	...
	VLayerClipElem( const VAffineTransform& inCTM, const VRect& inBounds, const VRect& inPrevClipBounds, const VRegion *inPrevClipRegion,
					...
					bool inHasClipOverride, bool inOwnOffScreen = true, VGraphicFilterProcess *inFilter = NULL);
	...
	*/
	...
	/* get filter */
	VGraphicFilterProcess *GetFilter() const { return fFilter; }
