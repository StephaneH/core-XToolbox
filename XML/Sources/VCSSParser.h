...
namespace CSSProperty
{
	...
	typedef enum eTextDecorationStyle
	{
		kTEXT_DECORATION_STYLE_SOLID,
		kTEXT_DECORATION_STYLE_DOTTED,
		kTEXT_DECORATION_STYLE_DASHED,
		kTEXT_DECORATION_STYLE_DOUBLE,
		kTEXT_DECORATION_STYLE_SEMI_TRANSPARENT,
		kTEXT_DECORATION_STYLE_WORD
	} eTextDecorationStyle;
	
	typedef enum eTextTransform
	{
		kTEXT_TRANSFORM_NONE,
		kTEXT_TRANSFORM_CAPITALIZE,
		kTEXT_TRANSFORM_LOWERCASE,
		kTEXT_TRANSFORM_UPPERCASE,

		kTEXT_TRANSFORM_SMALL_UPPERCASE		//reserved by -d4-text-transform
	...
	public:
		...
		union 
		{
			...
			union 
			{
				...
				eTextDecorationStyle fTextDecorationStyle;
				eTextTransform fTextTransform;
			} css;
...
{
public:
	VCSSLexParser( int inTabSize = 4) : fTabSize(inTabSize) {}
