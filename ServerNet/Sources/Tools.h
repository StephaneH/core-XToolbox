...
namespace ServerNetTools
{
    ...
    void XTOOLBOX_API Set_4D_DefaultSSLPrivateKey(const VMemoryBuffer<>& inKeyBuffer);
    void XTOOLBOX_API Set_4D_DefaultSSLCertificate(const VMemoryBuffer<>& inKeyBuffer);
    ...
    //Source for client certificate, obtained through IKeyCertChainSource
    XTOOLBOX_API VKeyCertChain* RetainClientKeyCertChain();
    ...
    VError XTOOLBOX_API GetResourcesCertificateAndKey(VMemoryBuffer<>& outCertBuffer, VMemoryBuffer<>& outKeyBuffer);
    VError XTOOLBOX_API GetResourcesCertificateAndKey(VString& outCertString, VString& outKeyString);
};
...
public :
	...
	VKeyCertChain* RetainClientCertificate();
    void SetClientCertificateSource(IKeyCertChainSource* inKeyCertChainSrc);
...
private :
	...
	IKeyCertChainSource* fClientCertificateSource;
