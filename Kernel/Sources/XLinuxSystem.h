...
#include "Kernel/Sources/XBSDSystem.h"
...
namespace XLinuxSystem
{
	...
	bool SearchExecutablePath(const VString& inExecutableName, VFilePath& outPath);
	...
	inline sLONG8 GetProfilingFrequency()
	{
		return 1000000000;
	}

	inline bool	SearchExecutablePath(const VString& inExecutableName, VFilePath& outPath)
	{
		return XBSDSystem::SearchExecutablePath( inExecutableName, outPath);
	}
