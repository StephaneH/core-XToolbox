...
//Default 4D key and certificate are loaded from Resources/key.pem and cert.pem, and not from 4D.rsr(c)
#define WITH_DEFAULT_4D_CERTIFICATE_AS_PEM_FILE 1

#define WITH_UPDATED_CIPHER_SUITES 1

#define WITH_CLIENT_CERTIFICATE 1
