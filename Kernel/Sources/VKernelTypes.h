...
typedef enum SystemVersion
{
	...
	MAC_OSX_10_6	= 8,
	MAC_OSX_10_7	= 9,	// Lion
	MAC_OSX_10_8	= 10,	// Mountain Lion
	MAC_OSX_10_9	= 11,	// Maverick
	MAC_OSX_10_10	= 12	// Yosemite
} SystemVersion;
...
#define ENABLE_VTEXTSTYLE_EXT		1		//enable support for extended character styles (underline/strikeout style & color, shadow & shadow color, subscript/superscript, lowercase/uppercase)
											//(in order to reduce side effects on standard text edit, it is implemented through a pure virtual interface binded in VTextStyle;
											// extended style interface is derived & instanciated only in TextCore for Write view & commands)
