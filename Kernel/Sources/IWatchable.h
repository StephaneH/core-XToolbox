...
public:
	...
	void IW_SetHexVal(VObject*,VValueSingle& /*outName*/){;};
	void IW_SetHexVal(void*, VValueSingle& /*outName*/){;};
	void IW_SetHexVal(uBYTE*, VValueSingle& /*outName*/){;};
	void IW_SetHexVal(sBYTE*, VValueSingle& /*outName*/){;};
	void IW_SetHexVal(uLONG, VValueSingle& /*outName*/){;};
	void IW_SetHexVal(uLONG8, VValueSingle& /*outName*/){;};
	void IW_SetHexVal(sLONG, VValueSingle& /*outName*/){;};
	void IW_SetHexVal(sLONG8, VValueSingle& /*outName*/){;};
	void IW_SetOSTypeVal(uLONG, VValueSingle& /*outName*/){;};
